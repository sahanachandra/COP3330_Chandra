...
public class TaskList {
    ...
    public void addItem(ArrayList<TaskItem> taskList) {
        ...
        if(Date.charAt(6) == '3' || Date.charAt(6) == '4' || Date.charAt(6) == '5' || Date.charAt(6) == '6' || Date.charAt(6) == '7' || Date.charAt(6) == '8' || Date.charAt(6) == '9'){
            System.out.println("Date is not valid. Task not created.");
            return;
        }


        TaskItem newItem = new TaskItem(taskName, Date, description, false);
    ...
    public void editItem(ArrayList<TaskItem> taskList, int choice){
        ...
        try{
            ...
            System.out.println("Enter a new task  date (YYYY-MM-DD) for task " + choice + " :");
            Scanner DateInput = new Scanner(System.in);
            Date = DateInput.nextLine();
            ...
            TaskItem editedItem = new TaskItem(taskName, Date, description, false);
    ...
    public void loadList(File listFile){
        ...
        try {
            ...
            for(int i = 0; i < listSize; i++){
                ...
                TaskItem newItem = new TaskItem(taskName, Date, description, taskDone);
                taskList.add(newItem);
