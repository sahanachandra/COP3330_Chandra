...
class Tasktest {
    ...
    void editingTaskItemDescriptionChangesValue(){
        TaskList list = new TaskList();
        TaskItem newItem = new TaskItem("Clean room", "2020-12-14", "i need to clean my room", false);
        list.taskList.add(newItem);
        TaskItem editItem = new TaskItem("get food", "2020-11-25", "I need to get food later", false);
        list.taskList.set(0,editItem);
    ...
    void editingTaskItemDueDateChangesValue(){
        TaskList list = new TaskList();
        TaskItem newItem = new TaskItem("Get choclate", "2021-10-14", "I need to get choclate", false);
        list.taskList.add(newItem);
        TaskItem editItem = new TaskItem("get gas", "2020-12-30", "I need to get gas", false);
        list.taskList.set(0,editItem);
    ...
    void editingTaskItemDueDateFailsWithInvalidIndex(){
        TaskList list = new TaskList();
        TaskItem newItem = new TaskItem("Clean room", "2024-10-13", "i need to clean my room future", false);
        list.taskList.add(newItem);
    ...
    void editingTaskItemTitleChangesValue(){
        TaskList list = new TaskList();
        TaskItem newItem = new TaskItem("Paint house", "2021-09-14", "pick colors and, paint it", false);
        list.taskList.add(newItem);
        TaskItem editItem = new TaskItem("get gas", "2020-12-30", "why do i always need to get gas on the 20th", false);
        list.taskList.set(0,editItem);
    ...
    void editingTaskItemTitleFailsWithInvalidIndex(){
        TaskList list = new TaskList();
        TaskItem newItem = new TaskItem("Clean room", "2024-10-13", "i need to clean the room way in the future", false);
    ...
    void gettingTaskItemDescriptionSucceedsWithValidIndex(){
        ...
        TaskItem newItem = new TaskItem("Clean room", "2024-10-13", "i need to clean the room way in the future", false);
        list.taskList.add(newItem);
        assertEquals("i need to clean the room way in the future", list.taskList.get(0).getDescription());
    }
    ...
    void gettingTaskItemTitleSucceedsWithValidIndex(){
        ...
        TaskItem newItem = new TaskItem("Clean room", "2024-10-13", "i need to clean the room way in the future", false);
        list.taskList.add(newItem);
        assertEquals("Clean room", list.taskList.get(0).getName());
    }
    ...
    void removingTaskItemsDecreasesSize(){
        ...
        TaskItem newItem = new TaskItem("Clean room", "2024-10-13", "i need to clean the room way in the future", false);
        list.taskList.add(newItem);
        TaskItem newItem2 = new TaskItem("Clean room", "2024-10-13", "i need to clean the room way in the future", false);
        list.taskList.add(newItem2);
        TaskItem newItem3 = new TaskItem("Clean room", "2024-10-13", "i need to clean the room way in the future", false);
        list.taskList.add(newItem3);
        TaskItem newItem4 = new TaskItem("Clean room", "2024-10-13", "i need to clean the room way in the future", false);
